...
public class BookUtil_1_14_4
{
    ...
    public static boolean isInitialised() {
        return BookUtil_1_14_4.initialised;
    }
    
    public static boolean openBook(final ItemStack i, final Player p) {
        if (!BookUtil_1_14_4.initialised) {
            return false;
        }
        ...
        try {
            ...
            e.printStackTrace();
            BookUtil_1_14_4.initialised = false;
        }
    ...
    private static void sendPacket(final ItemStack i, final Player p) throws ReflectiveOperationException {
        final Object entityplayer = BookUtil_1_14_4.getHandle.invoke(p, new Object[0]);
        ...
        BookUtil_1_14_4.openBook.invoke(entityplayer, getItemStack(i), enumArray[0]);
    }
    ...
    static {
        BookUtil_1_14_4.initialised = false;
        try {
            BookUtil_1_14_4.getHandle = ReflectionUtils.getMethod("CraftPlayer", ReflectionUtils.PackageType.CRAFTBUKKIT_ENTITY, "getHandle", (Class<?>[])new Class[0]);
            BookUtil_1_14_4.openBook = ReflectionUtils.getMethod("EntityPlayer", ReflectionUtils.PackageType.MINECRAFT_SERVER, "openBook", ReflectionUtils.PackageType.MINECRAFT_SERVER.getClass("ItemStack"), ReflectionUtils.PackageType.MINECRAFT_SERVER.getClass("EnumHand"));
            BookUtil_1_14_4.initialised = true;
        }
        catch (ReflectiveOperationException e) {
            e.printStackTrace();
